  ...
  return (
    <div className="min-h-screen bg-[var(--dashboard-bg)] flex flex-col">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--saas-accent)] text-white text-sm font-medium hover:opacity-90 transition-opacity"
              >
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 text-white text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
              >
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-8 space-y-8">
        ...
        {htmlBlocks.length > 0 && (
          <div>
            <h2 className="text-lg font-semibold text-[var(--saas-light)] mb-4">Resultado HTML</h2>
            <HtmlOutput blocks={htmlBlocks} />
          </div>
        )}
      </main>
    </div>
